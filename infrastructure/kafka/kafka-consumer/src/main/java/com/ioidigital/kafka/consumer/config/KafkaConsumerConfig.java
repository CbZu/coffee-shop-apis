package com.ioidigital.kafka.consumer.config;

import com.ioidigital.kafka.config.data.KafkaConfigData;
import com.ioidigital.kafka.config.data.KafkaConsumerConfigData;
